...
ANaveAereaJugador::ANaveAereaJugador()
{
	...
	NaveInfo.Add("Vida", 100); //Dato asignado a la blueprint en el header de NaveAereaJugador
	Vida = 100;
	...
	if (InventoryItem != nullptr)
	{
		...
		if (InventoryItem != nullptr)
		{
			...
			case 5:
			{
				...
				UWorld* const World = GetWorld();
				World->SpawnActor<AMetralleta>(toPlayerT+FVector(100,100,0), FRotator::ZeroRotator);
